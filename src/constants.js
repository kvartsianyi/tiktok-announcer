export const WELLCOM_MESSAGE = `👋 Welcome, {nickname}.
		
<strong>How to use the bot:</strong>

🚀 Send me <strong>Tiktok username</strong>. Example: mrbeast.

🛑 To cancel announcements send me <strong>Tiktok username</strong> again.
`;
